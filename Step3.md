# Step3. somatic CNV detcted in each sample and visualization of results
...
### 1.1. The coverage of X/Y always too slow to detect, consequently, following analysis had removed the XY chromosome for flowing analysis 
...
### 1.2. The coverage of X/Y always too slow to detect, consequently, following analysis had removed the XY chromosome for flowing analysis 
...
## 2.  merge all individual results
...
## 3.  visualize the global CNV map in all samples
...
### 4.1  global CNV visualize in all samples
